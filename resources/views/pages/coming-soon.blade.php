            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    ...
                    <div class="text-center">
                        ...
                        <svg class="svg-rocket mt-md-5 mt-3" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 83.07909 127.50572">
                            <g class="rocket-inner">
                                <g class="rocket-clouds">
                                    <g>
                                        <path class="rocket-clouds__bubble"
                                    ...
                                    <path class="rocket-clouds__cloud"
                                ...
                                <g class="rocket-inner__rocket-and-lines">
                                    <g class="rocket-lines">
                                        <path class="rocket-lines__lines"
